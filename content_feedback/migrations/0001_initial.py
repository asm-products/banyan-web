...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'content_feedback_flaggedobject', (
        ...
        db.send_create_signal(u'content_feedback', ['FlaggedObject'])

        # Adding model 'HiddenObject'
        db.create_table(u'content_feedback_hiddenobject', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('createdAt', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
        ...
        db.send_create_signal(u'content_feedback', ['HiddenObject'])


    def backwards(self, orm):
        # Deleting model 'FlaggedObject'
        db.delete_table(u'content_feedback_flaggedobject')

        # Deleting model 'HiddenObject'
        db.delete_table(u'content_feedback_hiddenobject')
