...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding index on 'BanyanUserDevices', fields ['type']
        db.create_index(u'accounts_banyanuserdevices', ['type'])


    def backwards(self, orm):
        # Removing index on 'BanyanUserDevices', fields ['type']
        db.delete_index(u'accounts_banyanuserdevices', ['type'])
