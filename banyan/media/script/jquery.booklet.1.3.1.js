...
(function ($) {
	...
	$.fn.booklet.defaults = {
		name:                 'Banyan',                            // name of the booklet to display in the document title bar
        ...
        hoverThreshold:       0.50,                            // default percentage used for manual page dragging, sets the percentage amount a drag must be before moving next or prev
